# -*- coding: utf-8 -*-
# ============================================================
# Paso 6 - Particion documentada del gold set v3 (3562 items).
# ------------------------------------------------------------
# Requisitos:
...
#   train_gold_v3.csv, val_gold_v3.csv, test_gold_v3.csv
#   split_report_gold_v3.md  y  split_report_gold_v3.json
# ============================================================
...
g = pd.read_csv(DATA / "gold_set_v3.csv", encoding="utf-8-sig")
...
for s, fname in [("train", "train_gold_v3.csv"), ("val", "val_gold_v3.csv"), ("test", "test_gold_v3.csv")]:
...
with open(REP / "split_report_gold_v3.json", "w", encoding="utf-8") as f:
...
lines = []
lines.append("# Reporte de partición — gold set v3\n")
lines.append(f"- **Fuente:** `data/gold_set_v3.csv` — {total} ítems, {g['review_uid'].nunique()} reseñas únicas.")
...
lines.append("- El test es NUEVO (derivado del gold v3), no se reutilizó el test anterior.")
...
(REP / "split_report_gold_v3.md").write_text("\n".join(lines), encoding="utf-8")

print("=== PARTICIÓN gold v3 ===")
...
print("Archivos:", DATA / "train_gold_v3.csv", DATA / "val_gold_v3.csv", DATA / "test_gold_v3.csv")
print("Reporte:", REP / "split_report_gold_v3.md")
