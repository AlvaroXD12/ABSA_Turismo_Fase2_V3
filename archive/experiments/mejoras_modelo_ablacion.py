...
#
# Salidas:
#   outputs/reports/mejoras_ablacion_detalle.csv
#   outputs/reports/mejoras_ablacion_resumen.csv
#   outputs/visualizations/mejoras_ablacion_f1.png
# ============================================================
...
# Hiperparametros (comunes a todas las configuraciones para una comparacion justa)
MAX_LEN = 192
BATCH_SIZE = 8
EPOCHS = 8
LEARNING_RATE = 2e-5
...
SEEDS = [42, 7, 123]       # 3 semillas -> media+/-std y ensemble

# Configuraciones a comparar: (nombre, modelo_hf, tipo_cabezal)
CONFIGS = [
    ("mbert_textcnn",     "bert-base-multilingual-cased",                 "cnn"),     # ~tu modelo actual
    ("mbert_simple",      "bert-base-multilingual-cased",                 "simple"),  # ablacion del CNN
    ("xlmr_textcnn",      "xlm-roberta-base",                             "cnn"),
    ("xlmr_simple",       "xlm-roberta-base",                             "simple"),
...
for name, model_name, head in CONFIGS:
    ...
    for seed in SEEDS:
        ...
        pd.DataFrame(rows).to_csv(REPORTS_DIR / "mejoras_ablacion_detalle.csv", index=False, encoding="utf-8-sig")
    ...
    pd.DataFrame(resumen).to_csv(REPORTS_DIR / "mejoras_ablacion_resumen.csv", index=False, encoding="utf-8-sig")
...
if len(res):
    ...
    plt.savefig(VIS_DIR / "mejoras_ablacion_f1.png", dpi=180)
    print("\nGuardado:", VIS_DIR / "mejoras_ablacion_f1.png")
